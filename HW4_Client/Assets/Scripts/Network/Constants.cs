public class Constants
{
	...
	public static readonly short CMSG_ColorChange = 107;
	public static readonly short SMSG_ColorChange = 207;
	public static readonly short CMSG_Win = 108;
	public static readonly short SMSG_Win = 208;
	public static readonly short CMSG_Test = 109;
	public static readonly short SMSG_Test = 209;
