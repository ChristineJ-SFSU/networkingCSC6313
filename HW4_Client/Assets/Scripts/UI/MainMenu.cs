...
public class MainMenu : MonoBehaviour
{
	...
	private void StartHotseatGame()
	{
		...
		Player player1 = new Player(1, p1Name, new Color(0.9f, 0.1f, 0.1f), new Color(0.5f, 0.1f, 0.1f), true);
		Player player2 = new Player(2, p2Name, new Color(0.2f, 0.2f, 1.0f),  new Color(0.9f, 0.1f, 0.4f), true);
	...
	private void StartNetworkGame()
	{
		...
		Player player1 = new Player(1, p1Name, new Color(0.9f, 0.1f, 0.1f), new Color(0.5f, 0.1f, 0.1f), Constants.USER_ID == 1);
		Player player2 = new Player(2, p2Name, new Color(0.2f, 0.2f, 1.0f), new Color(0.9f, 0.1f, 0.4f), Constants.USER_ID == 2);
		gameManager.Init(player1, player2);
		SceneManager.LoadScene("Game");
	}
}
