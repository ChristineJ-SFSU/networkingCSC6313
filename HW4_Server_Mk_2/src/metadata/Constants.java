...
public class Constants {
	...
	final public static short CMSG_ColorChange = 107;
	final public static short SMSG_ColorChange = 207;
	final public static short CMSG_Win = 108;
	final public static short SMSG_Win = 208;
	final public static short CMSG_Test = 109;
	final public static short SMSG_Test = 209;
